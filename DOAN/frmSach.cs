    ...
    public partial class frmSach : Form
    {
        ...
        private void BtnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (flag > 0)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    s.XoaSach(dgvSach.CurrentRow.Cells["MaSach"].Value.ToString());
        ...
        private void BtnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (themmoi)
            {
                s.ThemSach(txtMaSach.Text ,txtTenSach.Text, txtTacGia.Text, int.Parse(txtNamXB.Text), txtNhaXB.Text, float.Parse(txtTriGia.Text), ngay);
        ...
        private void FrmSach_SizeChanged(object sender, EventArgs e)
        {
            panelDgv.Height = this.ClientSize.Height / 2;
        }
    }
}
